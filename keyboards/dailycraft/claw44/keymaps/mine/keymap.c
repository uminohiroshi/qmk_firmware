...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    //,--------+--------+---------+--------+---------+--------.   ,--------+---------+--------+---------+--------+--------.
        K_A_TAB, KC_Q   , KC_W    , KC_E   , KC_R    , KC_T   ,     KC_Y   , KC_U    , KC_I   , KC_O    , KC_P   , K_A_AT ,
    //|--------+--------+---------+--------+---------+--------|   |--------+---------+--------+---------+--------+--------|
        KC_LCTL, KC_A   , KC_S    , KC_D   , KC_F    , KC_G   ,     KC_H   , KC_J    , KC_K   , KC_L    ,KC_SCLN , K_C_CLN,
    //|--------+--------+---------+--------+---------+--------|   |--------+---------+--------+---------+--------+--------|
        KC_LSFT, KC_Z   , KC_X    , KC_C   , KC_V    , KC_B   ,     KC_N   , KC_M    , KC_COMM, KC_DOT  ,KC_SLSH, K_S_BSL,
    //`--------+--------+---------+--------+---------+--------/   \--------+---------+--------+---------+--------+--------'
                          KC_LALT , K_L_BS , K_R_SPC ,K_N_F13 ,    K_N_F14 , K_R_SPC , K_L_ENT, KC_RALT
    ...
    [_MISC] = LAYOUT( \
    //,--------+--------+---------+--------+---------+--------.   ,--------+---------+--------+---------+--------+--------.
        _______, DM_REC1, DM_REC2 , KC_MPRV, KC_MNXT , KC_MPLY,     KC_APP , KC_NO   , KC_NO  , KC_NO   , KC_NO  , _______,
    //,--------+--------+---------+--------+---------+--------.   ,--------+---------+--------+---------+--------+--------.
        _______, DM_PLY1, DM_PLY2 , KC_VOLU, KC_VOLD , KC_MUTE,     DF(0)  , CM_ON   , KC_NO  , KC_NO   , KC_NO  , _______,
    //,--------+--------+---------+--------+---------+--------.   ,--------+---------+--------+---------+--------+--------.
        _______, DM_RSTP, DM_RSTP , KC_MRWD, KC_MFFD , KC_MSEL,     DF(1)  , CM_OFF  , KC_NO  , KC_NO   , KC_NO  , _______,
    //,--------+--------+---------+--------+---------+--------.   ,--------+---------+--------+---------+--------+--------.
                          QK_BOOT , _______, _______ , _______,     _______, _______ , _______, QK_BOOT
    //                 `----------+--------+---------+--------'   `--------+---------+--------+---------'
    ),

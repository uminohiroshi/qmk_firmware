...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    //,--------+--------+--------+--------+--------+--------+--------+                          .--------+--------+--------+--------+--------+--------+--------.
        K_C_F13, KC_A   , KC_S   , KC_D   , KC_F   , KC_G   , KC_INS                            , JP_RBRC, KC_H   , KC_J   , KC_K   , KC_L   ,JP_SCLN , K_C_CLN,
    //,--------+--------+--------+--------+--------+--------+--------+                          .--------+--------+--------+--------+--------+--------+--------.
        KC_LSFT, K_G_Z  , K_A_X  , K_C_C  , K_S_V  , KC_B   , KC_NO                             , KC_NO  , KC_N   , K_S_M  ,K_C_COMM, K_A_DOT,K_G_SLSH, K_S_BSL,
    //,--------+--------+--------+--------+--------+--------+--------+--------+        .--------+--------+--------+--------+--------+--------+--------+--------.
    ...
    //,--------+--------+--------+--------+--------+--------+--------+                          .--------+--------+--------+--------+--------+--------+--------.
        KC_LCPO, JP_ZKHK, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, _______                           , _______, KC_BSPC, KC_ESC , KC_DEL , JP_HENK, JP_MHEN, KC_RCPC,
    //,--------+--------+--------+--------+--------+--------+--------+                          .--------+--------+--------+--------+--------+--------+--------.

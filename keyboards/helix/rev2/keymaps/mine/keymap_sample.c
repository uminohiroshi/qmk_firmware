...
// raise layer
#define K_G_ZKHK    LGUI_T(JP_ZKHK)
#define K_A_LEFT    LALT_T(KC_LEFT)
#define K_C_DOWN    LCTL_T(KC_DOWN)
#define K_S_RGHT    LSFT_T(KC_RGHT)

#define K_S_ESC     RSFT_T(KC_ESC)
#define K_C_DEL     RCTL_T(KC_DEL)
#define K_A_HENK    RALT_T(JP_HENK)
#define K_G_MHEN    RGUI_T(JP_MHEN)


// lower layer
#define K_G_1       LGUI_T(JP_1)
#define K_A_2       LALT_T(JP_2)
#define K_C_3       LCTL_T(JP_3)
#define K_S_4       LSFT_T(JP_4)

#define K_S_7       RSFT_T(JP_7)
#define K_C_8       RCTL_T(JP_8)
#define K_A_9       RALT_T(JP_9)
#define K_G_0       RGUI_T(JP_0)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    //|--------+--------+---------+--------+---------+--------|   |--------+---------+--------+---------+--------+--------|
        K_C_F13, K_G_A  , K_A_S   , K_C_D  , K_S_F   , KC_G   ,     KC_H   , K_S_J   , K_C_K  , K_A_L   ,K_G_SCLN, K_C_CLN,
    //|--------+--------+---------+--------+---------+--------|   |--------+---------+--------+---------+--------+--------|
    ...
    //,--------+--------+---------+--------+---------+--------.   ,--------+---------+--------+---------+--------+--------.
       KC_LCPO ,K_G_ZKHK, K_A_LEFT,K_C_DOWN, K_S_RGHT, KC_PGDN,    KC_BSPC , K_S_ESC , K_C_DEL, K_A_HENK,K_G_MHEN, KC_RCPC, \
    //,--------+--------+---------+--------+---------+--------.   ,--------+---------+--------+---------+--------+--------.
    ...
    //|--------+--------+--------+--------+--------+--------|   |--------+--------+--------+--------+--------+--------|
        KC_LCTL,  K_G_1 , K_A_2  , K_C_3  , K_S_4  , JP_5   ,     JP_6   , K_S_7  , K_C_8  , K_A_9  , K_G_0  , KC_RCTL, \
    //|--------+--------+--------+--------+--------+--------|   |--------+--------+--------+--------+--------+--------|
